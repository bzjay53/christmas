...
| 날짜 | 문서 | 변경 내용 |
|------|------|-----------|
| 2025-06-29 | environments/production/config/deployment_config.json | 정식 버전 배포 설정 파일 작성 |
| 2025-06-29 | scripts/production_deployment.py | 정식 버전 배포 스크립트 개발 |
| 2025-06-27 | environments/production/config/issues_resolver_config.json | 프로덕션 환경 이슈 해결 설정 파일 작성 |
| 2025-06-27 | scripts/production_issues_resolver.py | 프로덕션 환경 이슈 해결 스크립트 개발 |
| 2025-06-27 | environments/production/production_issues_checklist.md | 프로덕션 환경 이슈 체크리스트 업데이트 |
...
| 2025-05-13 | docs/bugfix_tracking_summary.md | 버그 수정 및 이슈 추적 요약 문서 작성 |
...
| 2023-12-10 | environments/beta/config/issue_response.json | 이슈 대응 시스템 테스트 완료 및 활성화 |
...
| 2023-12-10 | 20. document_map.md | 베타 테스트 준비 문서 카테고리 추가 |
| 2023-12-10 | 18. christmas_wbs.md | 베타 버전 준비 완료 및 WBS 업데이트 |
| 2023-12-10 | 20. document_map.md | 베타 테스트 준비