          ...
          <div style={{ 
            ...
            <div style={{ 
              ...
              <div style={{
                ...
                borderRadius: '12px',
                padding: isMobile ? '15px' : '25px',
                height: isMobile ? '380px' : 'auto', // 차트 크기에 맞춘 높이 조정 (340px → 380px)
                minHeight: isMobile ? '380px' : 'auto', // 최소 높이 고정
                maxHeight: isMobile ? '380px' : 'auto', // 최대 높이 제한
                transition: isMobile ? 'none' : 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)', // 모바일에서 transition 비활성화
                boxShadow: theme === 'dark' 
                  ? '0 4px 20px rgba(0, 0, 0, 0.25)' 
                  : '0 4px 20px rgba(0, 0, 0, 0.08)',
                ...
                <div style={{ 
                  height: isMobile ? '320px' : 'calc(100% - 60px)', // 모바일에서 고정 높이 (285px → 320px)
                  width: '100%',
                  position: 'relative'
                }}>
                  <VolumeChart />
